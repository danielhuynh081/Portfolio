        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-start">
          ...
          >
            <form className="flex flex-col space-y-6">
              ...
              <button
                type="submit"
                className="self-start px-8 py-4 bg-primary text-white font-bold uppercase tracking-widest text-xs rounded-md hover:opacity-90 transition-opacity shadow-sm"
              >
                Send Message
              </button>
            </form>
